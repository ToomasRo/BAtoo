...
def main():
    ...
    epochs = 1000
    cur_dir = os.getcwd()
    directory = "const_func_uneven_data_2"
    ...
    for train_size in train_sizes:    # kõik suurused
        ...
        for different_place in different_places:  # kõik erinevad kohad
            ...
            for different_multiplier in different_multipliers:  # kõik erinevad korrutajad
                ...
                model.save(
                    f"{directory}/models/{train_size}_{different_multiplier}{chr(65+different_place)}_{seed}", overwrite=True)
